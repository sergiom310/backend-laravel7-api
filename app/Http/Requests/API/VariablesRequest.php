...
class VariablesRequest extends FormRequest
{
    ...
    {
        return [
            'des_variable' => 'required|max:45',
            'cod_variable' => 'required|max:20',
    ...
    {
        return [
            'des_variable.required' => 'des_variable es requerida',
            'des_variable.max' => 'des_variable debe ser maximo 45 caracteres.',
            'cod_variable.required' => 'cod_variable es requerida',
            'cod_variable.max' => 'cod_variable debe ser maximo 20 caracteres.',
