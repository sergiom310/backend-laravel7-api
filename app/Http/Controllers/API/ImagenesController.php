...
use App\Http\Requests\API\ImagenesRequest;
...
class ImagenesController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Imagenes::paginate($limit);
        } else {
            $response = Imagenes::all();
        }
    ...
    {
        try {
            $response = Imagenes::create($request->all());
    ...
    {
        $response = Imagenes::whereId($id)->get();
    ...
    {
        $response = Imagenes::findOrFail($id);
