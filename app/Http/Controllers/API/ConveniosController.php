...
use App\Http\Requests\API\ConveniosRequest;
...
class ConveniosController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Convenios::paginate($limit);
        } else {
            $response = Convenios::all();
        }
    ...
    {
        try {
            $response = Convenios::create($request->all());
    ...
    {
        $response = Convenios::whereId($id)->get();
    ...
    {
        $response = Convenios::findOrFail($id);
