...
use App\Http\Requests\API\ItemsRequest;
...
class ItemsController extends Controller
{
    ...
    {
        try {
            $response = Items::create($request->all());
