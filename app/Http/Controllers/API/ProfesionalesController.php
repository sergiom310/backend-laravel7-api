...
use App\Http\Requests\API\ProfesionalesRequest;
...
class ProfesionalesController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Profesionales::paginate($limit);
        } else {
            $response = Profesionales::all();
        }
    ...
    {
        try {
            $response = Profesionales::create($request->all());
    ...
    {
        $response = Profesionales::whereId($id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ProfesionalesRequest $request, $id)
    {
        $response = Profesionales::findOrFail($id);
