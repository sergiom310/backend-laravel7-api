...
use App\Http\Requests\API\PlantillasRequest;
...
class PlantillasController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Plantillas::paginate($limit);
        } else {
            $response = Plantillas::all();
        }
    ...
    {
        try {
            $response = Plantillas::create($request->all());
    ...
    {
        $response = Plantillas::whereId($id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(PlantillasRequest $request, $id)
    {
        $response = Plantillas::findOrFail($id);
