...
use App\Http\Requests\API\PlanesRequest;
...
class PlanesController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Planes::paginate($limit);
        } else {
            $response = Planes::all();
        }
    ...
    {
        try {
            $response = Planes::create($request->all());
    ...
    {
        $response = Planes::whereId($id)->get();
