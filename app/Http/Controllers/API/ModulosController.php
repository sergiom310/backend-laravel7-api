...
use App\Http\Requests\API\ModulosRequest;
...
class ModulosController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Modulos::paginate($limit);
        } else {
            $response = Modulos::all();
        }
    ...
    {
        try {
            $response = Modulos::create($request->all());
    ...
    {
        $response = Modulos::whereId($id)->get();
    ...
    {
        $response = Modulos::findOrFail($id);
