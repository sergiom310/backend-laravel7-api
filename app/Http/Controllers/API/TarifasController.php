...
use App\Http\Requests\API\TarifasRequest;
...
class TarifasController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Tarifas::paginate($limit);
        } else {
            $response = Tarifas::all();
        }
    ...
    {
        try {
            $response = Tarifas::create($request->all());
    ...
    {
        $response = Tarifas::whereId($id)->get();
    ...
    {
        $response = Tarifas::findOrFail($id);
