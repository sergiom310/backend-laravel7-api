...
use App\Http\Requests\API\TercerosRequest;
...
class TercerosController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Terceros::paginate($limit);
        } else {
            $response = Terceros::all();
        }
    ...
    {
        try {
            $response = Terceros::create($request->all());
    ...
    {
        $response = Terceros::whereId($id)->get();
    ...
    {
        $response = Terceros::findOrFail($id);
