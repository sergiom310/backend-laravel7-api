...
use App\Models\SubClases;
use Illuminate\Http\Request;
use App\Http\Requests\API\SubClasesRequest;
...
class SubClasesController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = SubClases::paginate($limit);
        } else {
            $response = SubClases::all();
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(SubClasesRequest $request)
    {
        try {
            $response = SubClases::create($request->all());
    ...
    {
        $response = SubClases::whereId($id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(SubClasesRequest $request, $id)
    {
        $response = SubClases::findOrFail($id);
