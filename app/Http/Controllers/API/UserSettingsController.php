...
use App\Http\Requests\API\UserSettingsRequest;
...
class UserSettingsController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = UserSettings::paginate($limit);
        } else {
            $response = UserSettings::all();
        }
    ...
    {
        try {
            $response = UserSettings::create($request->all());
    ...
    {
        $response = UserSettings::whereId($id)->get();
    ...
    {
        $response = UserSettings::findOrFail($id);
