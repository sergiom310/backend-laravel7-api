...
use App\Models\SedesUsers;
use Illuminate\Http\Request;
use App\Http\Requests\API\SedesUsersRequest;

class SedesUsersController extends Controller
{
    /**
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = SedesUsers::paginate($limit);
        } else {
            $response = SedesUsers::all();
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(SedesUsersRequest $request)
    {
        try {
            $response = SedesUsers::create($request->all());
    ...
    {
        $response = SedesUsers::whereId($id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(SedesUsersRequest $request, $id)
    {
        $response = SedesUsers::findOrFail($id);
