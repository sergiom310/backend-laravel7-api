...
use App\Http\Requests\API\HistoriasClinicasRequest;
...
class HistoriasClinicasController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = HistoriasClinicas::paginate($limit);
        } else {
            $response = HistoriasClinicas::all();
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(HistoriasClinicasRequest $request)
    {
        try {
            $response = HistoriasClinicas::create($request->all());
    ...
    {
        $response = HistoriasClinicas::whereId($id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(HistoriasClinicasRequest $request, $id)
    {
        $response = HistoriasClinicas::findOrFail($id);
