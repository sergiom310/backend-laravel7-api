...
use App\Models\PlanesServicios;
use Illuminate\Http\Request;
use App\Http\Requests\API\PlanesServiciosRequest;
...
class PlanesServiciosController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = PlanesServicios::paginate($limit);
        } else {
            $response = PlanesServicios::all();
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(PlanesServiciosRequest $request)
    {
        try {
            $response = PlanesServicios::create($request->all());
    ...
    {
        $response = PlanesServicios::whereId($id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(PlanesServiciosRequest $request, $id)
    {
        $response = PlanesServicios::findOrFail($id);
