...
use App\Models\TarifasItems;
use Illuminate\Http\Request;
use App\Http\Requests\API\TarifasItemsRequest;

class TarifasItemsController extends Controller
{
    /**
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = TarifasItems::paginate($limit);
        } else {
            $response = TarifasItems::all();
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(TarifasItemsRequest $request)
    {
        try {
            $response = TarifasItems::create($request->all());
    ...
    {
        $response = TarifasItems::whereId($id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(TarifasItemsRequest $request, $id)
    {
        $response = TarifasItems::findOrFail($id);
