...
use App\Http\Requests\API\VariablesRequest;
...
class VariablesController extends Controller
{
    ...
    public function index()
    {
        if ($page = \Request::get('page')) {
            ...
            $response = Variables::paginate($limit);
        } else {
    ...
    {
        try {
            $response = Variables::create($request->all());
    ...
    {
        $response = Variables::whereId($id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(VariablesRequest $request, $id)
    {
        $response = Variables::findOrFail($id);
